(function() {
  ...
  FriendsCtrl.$inject = ['$scope', "$rootScope", "$state", "FriendsList"];
  ...
  function FriendsCtrl($scope, $rootScope, $state, FriendsList){
    var vm = $scope.vm = {};
    angular.extend(vm, {
      friend: {},
      friends: FriendsList.all(),

      openChatRoom: openChatRoom
    });

    function openChatRoom(chatToUser) {
